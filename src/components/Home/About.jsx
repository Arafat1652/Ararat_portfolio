            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow"> ARAFAT HOSEN </span>
                 and I'm from <span className="yellow"> Dhaka, Bangladesh.</span>
                <br />
                <br />
                Currently, I'm pursuing my Bachelor's degree in Physics.
                <br />
                <br />
                  As a
              ...
              <Col md={4} className="myAvtar">
                <Tilt>
                  <img src={'https://i.im.ge/2025/01/01/zZKA1Y.Arafat.jpeg'} className="img-fluid arafat" alt="avatar" />
                </Tilt>
              </Col>
            </Row>
            <Row>
